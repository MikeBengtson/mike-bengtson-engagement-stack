...
- [ ] Create a local `private/` directory for sensitive overlays (compensation, constraints, negotiation) if private thresholds or constraints are needed; it is gitignored and never committed.
